...
st.markdown("""
    <style>
    .header-logo { display: flex; justify-content: center; margin-bottom: 5px; }
    .header-logo img { width: 150px; border-radius: 8px; }
    .header-title { text-align: center; font-size: 28px; font-weight: bold; margin-bottom: 20px; }
